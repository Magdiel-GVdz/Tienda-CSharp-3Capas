...
namespace Tienda_Presentacion {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductoRow AddProductoRow(int Id, string descripcion, string marca, string precio) {
...
namespace Tienda_Presentacion.Database1DataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Producto] WHERE (([Id] = @Original_Id) AND ([descripcion] = @O" +
                "riginal_descripcion) AND ([marca] = @Original_marca) AND ([precio] = @Original_p" +
                "recio))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Producto] ([Id], [descripcion], [marca], [precio]) VALUES (@Id" +
                ", @descripcion, @marca, @precio);\r\nSELECT Id, descripcion, marca, precio FROM Pr" +
                "oducto WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Id] = @Id, [descripcion] = @descripcion, [marca] = @marca, [precio] = @precio WHERE (([Id] = @Original_Id) AND ([descripcion] = @Original_descripcion) AND ([marca] = @Original_marca) AND ([precio] = @Original_precio));
SELECT Id, descripcion, marca, precio FROM Producto WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Tienda_Presentacion.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        public virtual int Delete(int Original_Id, string Original_descripcion, string Original_marca, string Original_precio) {
        ...
        public virtual int Insert(int Id, string descripcion, string marca, string precio) {
        ...
        public virtual int Update(int Id, string descripcion, string marca, string precio, int Original_Id, string Original_descripcion, string Original_marca, string Original_precio) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string descripcion, string marca, string precio, int Original_Id, string Original_descripcion, string Original_marca, string Original_precio) {
            return this.Update(Original_Id, descripcion, marca, precio, Original_Id, Original_descripcion, Original_marca, Original_precio);
        }
    }
